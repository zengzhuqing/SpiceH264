/* foreign-menu.c generated by valac 0.22.1, the Vala compiler
...
void spice_ctrl_foreign_menu_menu_item_checked_msg (SpiceCtrlForeignMenu* self, gint32 item_id, gboolean checked) {
	...
	int _tmp9_ = 0;
	guint8* p = NULL;
	FrgMenuEvent _tmp10_ = {0};
	FrgMenuMsg _tmp11_ = {0};
	guint32 _tmp12_ = 0U;
	gint p_length1 = 0;
	gint _p_size_ = 0;
	guint8* _tmp13_ = NULL;
	...
	g_signal_emit_by_name (_data_->self, "client-connected");
	{
		...
		while (TRUE) {
			...
			if (((gulong) _data_->_tmp59_) > sizeof (FrgMenuMsg)) {
				...
				_data_->_state_ = 5;
				spice_ctrl_input_stream_read (_data_->_tmp66_, _data_->_tmp67_ + ((gint) sizeof (FrgMenuMsg)), ((gint) _data_->_tmp69_) - ((gint) sizeof (FrgMenuMsg)), spice_ctrl_foreign_menu_handle_client_ready, _data_);
				return FALSE;
				_state_5:
				spice_ctrl_input_stream_read_finish (_data_->_res_, &_data_->_inner_error_);
				if (_data_->_inner_error_ != NULL) {
